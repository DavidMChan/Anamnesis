...
class WasabiConfig:
    ...
    region: str = field(default_factory=lambda: os.environ.get("WASABI_REGION", "us-east-1"))
    endpoint: str = field(default_factory=lambda: os.environ.get("WASABI_ENDPOINT", "https://s3.us-east-1.wasabisys.com"))
