  ...
  ({ className, disabled, ...props }, ref) => {
    ...
    return (
      <button
        ...
        type="button"
        className={cn(
          'inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-150',
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
          'disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
          'bg-white text-gray-700 border border-input shadow-sm hover:bg-gray-50 hover:shadow-md',
          'h-11 px-5 py-2 w-full',
          className
        )}
        disabled={isDisabled}
        onClick={handleClick}
